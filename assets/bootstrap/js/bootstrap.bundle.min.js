...
document.getElementById('footer04-6x').remove();
...
myFooterDiv.innerHTML = `
    <footer class="d-flex align-items-center justify-content-center py-3"
        ...
        <p class="mbr-text mbr-fonts-style display-7 mb-0">© Copyright 2025 - Francesco Salvador Sua Wao - Informatika Universitas Respati Yogyakarta
        </p>
    </footer>
`;
