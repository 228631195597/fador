...
// delete id="footer04-30" and last section
document.getElementById('footer04-3c').remove();
...
myFooterDiv.innerHTML = `
    <footer class="d-flex align-items-center justify-content-center py-3"
        ...
        <img src="assets/images/logo-unriyo-414x414.png" alt="Logo" class="me-2" style="width: 50px;"> </a>
        <p class="mbr-text mbr-fonts-style display-7 mb-0">© Copyright 2025 - Francesco Salvador Sua Wao - Informatika Universitas Respati Yogyakarta - Jln satria III, Sanggarahang Maguwohardjo</p>
    </footer>
`;
